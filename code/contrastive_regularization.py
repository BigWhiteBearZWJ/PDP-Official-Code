...
class ContrastiveLoss(AbstractLossClass):
    ...
    def forward(self, common, tar, src):
        ...
        # print("real:", self.id_contrastive_loss(real_common, real_tar, real_src))
        # print("-----")
        # print("fake:", self.id_contrastive_loss(fake_common, fake_tar, fake_src))

        # loss_id = self.id_contrastive_loss(real_common, real_tar, real_src) + self.id_contrastive_loss(fake_common, fake_tar, fake_src)
        ...
        # loss = loss_realcommon + loss_fakecommon + loss_id
        loss = loss_id
        return loss